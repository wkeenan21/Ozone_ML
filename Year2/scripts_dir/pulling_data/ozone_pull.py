...
for year in years:
    for month in months:
        ...
        do = do['Data']
        do = pd.DataFrame(do)
        do.to_csv(r"D:\Will_Git\Ozone_ML\Year2\EPA_Data\v2\year{}month{}.csv".format(year, month))
...
for year in years:
    for month in months:
        dfv1 = pd.read_csv(r"D:\Will_Git\Ozone_ML\Year2\EPA_Data\year{}month{}.csv".format(year, month))
        dfv2 = pd.read_csv(r"D:\Will_Git\Ozone_ML\Year2\EPA_Data\v2\year{}month{}.csv".format(year, month))

        print('len v1: {}, len v2: {}'.format(len(dfv1), len(dfv2)))