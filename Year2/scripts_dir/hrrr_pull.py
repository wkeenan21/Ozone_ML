...
sites = pd.read_csv(r"D:\Will_Git\Ozone_ML\Year2\BasicGIS\ozone_sites.csv")
toDrop = []
...
for year in years:
    ...
    for month in months:
        ...
        outPath = r"D:\Will_Git\Ozone_ML\Year2\HRRR_Data\meteorology\year{}month{}.csv".format(year, month.month)
        if not os.path.exists(outPath):
            ...
            monthDf.to_csv(r"D:\Will_Git\Ozone_ML\Year2\HRRR_Data\meteorology\year{}month{}.csv".format(year, month.month))
